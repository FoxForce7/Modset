...
{
	class ff7_insignia_foxo
	{
		displayName="FoxForce7-Orange";
		author="FoxForce7";
		texture="\ff7_core\data\logo_ff7_1_ca.paa";
		textureVehicle="";
	};
	class ff7_insignia_foxg
	{
		displayName="FoxForce7-Grey";
		author="FoxForce7";
		texture="\ff7_core\data\logo_ff7_2_ca.paa";
		textureVehicle="";
	};
	class ff7_insignia_foxb
	{
		displayName="FoxForce7";
		author="FoxForce7";
		texture="\ff7_core\data\logo_ff7_0_ca.paa";
		textureVehicle="";
	};
};
class CfgMods
{
	...
	{
		author="FoxForce7";
		picture="\logo_ff7_ca.paa";
		logo="\ff7_core\data\logo_ff7_1_ca.paa";
		logoOver="\ff7_core\data\logo_ff7_2_ca.paa";
		logoSmall="\ff7_core\data\logo_ff7_2_ca.paa";
		dlcColor[]={0.82999998,0.31999999,0.023,1};
		fieldManualTopicAndHint[]={};
		hideName=0;
		hidePicture=0;
		tooltip="FoxForce7";
		tooltipOwned="noone owning this tooltip";
		name="FoxForce7";
		overview="insert cryptic comment here, or don`t, but keep it secret, because...";
		action="https://units.arma3.com/unit/fox-force-7";
	};
	author="FoxForce7";
	timepacked="1530329403";
};
